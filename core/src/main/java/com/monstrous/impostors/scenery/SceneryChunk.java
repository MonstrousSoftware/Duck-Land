...
import com.monstrous.impostors.PoissonDiscDistribution;
...
public class SceneryChunk implements Disposable {
    ...
    public SceneryChunk(int cx, int cz, int creationTime, int key, Terrain terrain, float separationDistance) {
        ...
        Array<Vector2> points = PoissonDiscDistribution.generatePoissonDistribution(separationDistance, area);
