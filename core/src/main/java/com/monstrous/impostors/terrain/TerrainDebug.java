...
public class TerrainDebug {
    ...
    public TerrainDebug( Terrain terrain ) {
        ...
        pixmap.setColor(0, 0, 1, 0.2f);
        pixmap.drawPixel(0,0);
        pixmap.setColor(1, 0, 0, 1);
        pixmap.drawPixel(1,0);
        pixmap.setColor(0, 0, 1, 1);
        pixmap.drawPixel(2,0);
        pixmap.setColor(0, 1, 0f, 0.5f);
    ...
    public void debugRender(Vector3 playerPos, Vector3 camPos) {
        if(!Settings.debugTerrainChunkAllocation)
            return;
        ...
        // racer
        pos.set(playerPos);
        pos.x /=Settings.terrainChunkSize;
        pos.z /=Settings.terrainChunkSize;
        convert(pos);
        batch.draw(textureRegionPlayer, pos.x, pos.y, 4, 4);
